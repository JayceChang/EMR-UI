...
<template>
  ...
  <div class="logo" @click="onGoHome" :style="sideMenuWidth" v-if="!collapsed">
    ...
    <div class="title smart-logo title-light" v-if="sideMenuTheme === 'light'">{{ mainTitle }}</div>
    <div class="title smart-logo title-dark" v-if="sideMenuTheme === 'dark'">{{ mainTitle }}</div>
  </div>
