...
// report-query Vue 页面组件
import ReportPage from './views/business/rating/indicator/report/report-query.vue';
...
// 挂载到 report-query.html 中的 #report-query-app
const app = createApp(ReportPage,getUrlParams());
app.use(router)
    .use(store)
    .use(i18n)
    .use(Antd)
