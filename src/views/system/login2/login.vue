    ...
    <div class="box-item login">
      ...
      <a-form ref="formRef" class="login-form" :model="loginForm" :rules="rules">
        ...
        <a-form-item name="captchaCode">
          ...
          <img class="captcha-img" style="display: inline; margin-left: 10px" :src="captchaBase64Image" @click="getCaptcha" />
        </a-form-item>
        <a-form-item>
...
<script setup>
  ...
  //--------------------- 登录表单 ---------------------------------
  const { xmtitle, mainTitle } = useWindowConfigTitle();
