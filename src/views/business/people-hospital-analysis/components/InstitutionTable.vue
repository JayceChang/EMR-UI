      ...
      <table class="min-w-full bg-white border border-gray-200 rounded-lg shadow-sm">
        <thead class="bg-gray-50">
          <tr>
            ...
            <th class="py-3 px-4 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">详情</th>
          </tr>
        </thead>
        <tbody class="divide-y divide-gray-200">
          <tr v-for="item in filteredData" :key="item.name" class="hover:bg-gray-50 transition duration-150 ease-in-out">
            ...
            <!-- <td class="py-3 px-4 whitespace-nowrap text-sm text-gray-700">
              <div
                :id="`trend-${getChartId(item.name)}`"
                class="h-10 w-24 inline-block"
              ></div>
            </td> -->
