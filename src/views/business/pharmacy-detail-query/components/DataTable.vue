  ...
  <div class="bg-white rounded-xl p-5 table-shadow w-full lg:w-full overflow-x-auto">
    ...
    <div class="flex bg-white flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-4">
      <div class="flex items-center space-x-4">
        <h2 class="text-xl font-semibold">药房明细数据</h2>
    ...
    <div class="overflow-x-auto scrollbar-hide">
      ...
      >
        <template #bodyCell="{ column, record }">
          ...
          <template v-else-if="column.key === 'pharmacy'">
            <span class="text-gray-800">{{ record.pharmacy }}</span>
          </template>
...
const columns = [
  ...
  },
  {
    ...
    key: 'pharmacy',
    width: 180,
    sorter: (a, b) => a.pharmacy.localeCompare(b.pharmacy),
    ellipsis: true
  },
  {
    title: '总金额',
