<template>
  <div class="w-72 rounded-lg flex-shrink-0 overflow-y-auto">
    <div class="bg-white rounded-xl p-5 filter-card sticky">
        ...
        <div class="space-y-1">
          ...
          <div class="space-y-1">
            <a-select
              ...
              placeholder="选择开始月份"
            >
              <a-select-option value="2023-08">2024年07月</a-select-option>
              ...
              <a-select-option value="2023-12">2025年12月</a-select-option>
            </a-select>
            <a-select
