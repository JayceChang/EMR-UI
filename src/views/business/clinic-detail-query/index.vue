...
// API
import { ClinicDetailQueryAPI } from '/@/api/business/clinic-detail-query/clinic-detail-query-api';
...
// ICD subcategory data
const icdData = ref({
  'I00-I99': [
    { value: 'I00-I02', text: 'I00-I02 急性风湿热' },
    { value: 'I05-I09', text: 'I05-I09 慢性风湿性心脏病' },
    { value: 'I10-I15', text: 'I10-I15 高血压病' },
    { value: 'I20-I25', text: 'I20-I25 缺血性心脏病' },
    { value: 'I26-I28', text: 'I26-I28 肺栓塞和其他肺动脉病' },
    { value: 'I30-I52', text: 'I30-I52 其他心脏病' },
    { value: 'I60-I69', text: 'I60-I69 脑血管病' }
  ],
  'J00-J99': [
    { value: 'J00-J06', text: 'J00-J06 急性上呼吸道感染' },
    { value: 'J09-J18', text: 'J09-J18 流感和肺炎' },
    { value: 'J20-J22', text: 'J20-J22 其他急性下呼吸道感染' },
    { value: 'J30-J39', text: 'J30-J39 其他上呼吸道疾病' },
    { value: 'J40-J47', text: 'J40-J47 慢性下呼吸道疾病' }
  ]
});
...
const performQuery = async () => {
  ...
  try {
    // Call API
    const response = await ClinicDetailQueryAPI.getClinicDetailWithPage(
